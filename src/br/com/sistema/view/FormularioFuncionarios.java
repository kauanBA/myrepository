...
public class FormularioFuncionarios extends javax.swing.JDialog {
    ...
    private void initComponents() {
                    ...
                    .addGroup(painelDadosPessoaisLayout.createSequentialGroup()
                        .addGroup(painelDadosPessoaisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, painelDadosPessoaisLayout.createSequentialGroup()
                                ...
                                .addGap(10, 10, 10)
                                .addGroup(painelDadosPessoaisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtComplemento, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
                        ...
                        .addGroup(painelDadosPessoaisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(painelDadosPessoaisLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtCargo, javax.swing.GroupLayout.DEFAULT_SIZE, 132, Short.MAX_VALUE)))
                        .addGap(139, 139, 139))))
        );
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Email", "Senha", "Cargo", "Nível", "Celular", "Telefone", "CEP", "Endereço", "Número", "Bairro", "Cidade", "Complemento", "UF", "RG", "CPF"
            }
        ));
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        txtRG.setText(tabela.getValueAt(tabela.getSelectedRow(), 15).toString());
        txtCpf.setText(tabela.getValueAt(tabela.getSelectedRow(), 16).toString());
        ...
        txtCargo.setText(tabela.getValueAt(tabela.getSelectedRow(), 4).toString());
        cbNivel.setSelectedItem(tabela.getValueAt(tabela.getSelectedRow(), 5).toString());
        ...
        txtEndereco.setText(tabela.getValueAt(tabela.getSelectedRow(), 9).toString());
        txtNumero.setText(tabela.getValueAt(tabela.getSelectedRow(), 10).toString());
        ...
        cbUF.setSelectedItem(tabela.getValueAt(tabela.getSelectedRow(), 14).toString());
