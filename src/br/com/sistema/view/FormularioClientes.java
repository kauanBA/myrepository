...
public class FormularioClientes extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Email", "Celular", "Telefone", "CEP", "Endereço", "Número", "Bairro", "Cidade", "Complemento", "UF", "RG", "CPF"
            }
        ));
...
String nome = "%"+txtPesquisaNome.getText()+"%";
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        txtRG.setText(tabela.getValueAt(tabela.getSelectedRow(), 12).toString());
        txtCpf.setText(tabela.getValueAt(tabela.getSelectedRow(), 13).toString());
